...
const callBtnHeader = document.querySelector('.header-container__button-call');
...
callBtnHeader.addEventListener('click', function(event){
    event.preventDefault();
    callBody.classList.add('modul-active');
    modulCall.classList.add('modul-active');
});
...
const chatBtnHeader = document.querySelector('.header-container__button-chat');
...
chatBtnHeader.addEventListener('click', function(event){
    event.preventDefault();
    feedbackBody.classList.add('modul-active');
    modulFeedback.classList.add('modul-active');
});
